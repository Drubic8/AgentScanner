...
- [Изменения версии 2.0.1](docs/releases/2.0.1.md).
...
Для испытаний на ASIC подготовлены [матрица Excel](docs/testing/asic_acceptance.xlsx)
и [инструкция по приёмке и сбору диагностики](docs/testing/README.md).
Сборщик `python -m miner_scanner.diagnostics` выполняет только чтение и сохраняет
ZIP с обезличенными ответами API, задержками и ошибками. Запускайте его на ПК
с доступом к сети оборудования; подробные команды приведены в инструкции.
