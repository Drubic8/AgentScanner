...
WHATSMINER_ERRORS = {
    ...
    # ==========================================
    # 4.5 ОШИБКИ БАЛАНСИРОВКИ, ЧАСТОТЫ И БИТЫХ ЧИПОВ (55x - 59x)
    # ==========================================
    "550": "Hashboard 0 have bad chips (На хеш-плате 0 найдены битые чипы)",
    "551": "Hashboard 1 have bad chips (На хеш-плате 1 найдены битые чипы)",
    "552": "Hashboard 2 have bad chips (На хеш-плате 2 найдены битые чипы)",
    
    "560": "Hashboard 0 loss balance (Плата 0 потеряла баланс напряжения/тока)",
    "561": "Hashboard 1 loss balance (Плата 1 потеряла баланс напряжения/тока)",
    "562": "Hashboard 2 loss balance (Плата 2 потеряла баланс напряжения/тока)",

    "570": "Hashboard 0 voltage/power error (Сбой питания/напряжения на плате 0)",
    "571": "Hashboard 1 voltage/power error (Сбой питания/напряжения на плате 1)",
    "572": "Hashboard 2 voltage/power error (Сбой питания/напряжения на плате 2)",
    
    "580": "Hashboard 0 communication/sensor error (Сбой связи/датчиков на плате 0)",
    "581": "Hashboard 1 communication/sensor error (Сбой связи/датчиков на плате 1)",
    "582": "Hashboard 2 communication/sensor error (Сбой связи/датчиков на плате 2)",

    "590": "Hashboard 0 frequency is too low (Частота на плате 0 слишком низкая)",
    "591": "Hashboard 1 frequency is too low (Частота на плате 1 слишком низкая)",
    "592": "Hashboard 2 frequency is too low (Частота на плате 2 слишком низкая)",
    ...
    # ==========================================
    # 9. ОШИБКИ ВОДЯНОГО/ИММЕРСИОННОГО ОХЛАЖДЕНИЯ (HYDRO/IMMERSION)
    # ==========================================
    "652": "The liquid temperature fluctuation is too large (Слишком большие колебания температуры жидкости)",
}